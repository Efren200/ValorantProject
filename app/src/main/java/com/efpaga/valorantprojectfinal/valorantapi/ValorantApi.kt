package com.efpaga.valorantprojectfinal.valorantapi

import com.efpaga.valorantprojectfinal.valorantapi.utils.send
import com.google.gson.*
import com.efpaga.valorantprojectfinal.valorantapi.services.ValorantApiService
...
//todo Este consumo de la api lo copie de un github que consumia todo lo que yo necesitava para la aplicacion.
...
class ValorantApi(
    ...
    fun getSprays(): BaseModel<Array<Spray>> = service.sprays().send()
    fun getBundles(): BaseModel<Array<Bundles>> = service.bundles().send()
